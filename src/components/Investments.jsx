...
import { Plus, X, PieChart, Calendar, TrendingUp, AlertCircle, Trash2, Edit2 } from 'lucide-react';
...
const Investments = () => {
    ...
    const investmentTypes = ['CDB', 'LCI', 'LCA', 'Stock', 'FII', 'Treasury', 'Crypto', 'Other'];
            ...
            <div style={{ display: 'flex', gap: '24px', marginBottom: '48px', flexWrap: 'wrap' }}>
                ...
                <div style={{ flex: 1, minWidth: '300px', height: '300px', backgroundColor: 'var(--notion-bg)', border: '1px solid var(--notion-border)', borderRadius: '8px', padding: '24px', position: 'relative' }}>
                    ...
                    <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', textAlign: 'center', pointerEvents: 'none' }}>
                        <div style={{ fontSize: '12px', color: 'var(--notion-text-gray)' }}>Total</div>
                    ...
                    {investments.map((item) => (
                        <div key={item.id} style={{
                            ...
                            <div style={{ flex: 2, display: 'flex', alignItems: 'center', gap: '12px' }}>
                                <div style={{ width: '32px', height: '32px', borderRadius: '4px', backgroundColor: 'var(--notion-hover)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                    <TrendingUp size={16} color="var(--notion-text)" />
                                </div>
                                <div>
                            ...
                            <div style={{ flex: 1, textAlign: 'right', color: 'var(--notion-text-gray)' }}>
