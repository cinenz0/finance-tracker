...
const Sidebar = ({ activeTab, setActiveTab }) => {
    ...
    return (
        <aside style={{
            ...
            <div
                style={{ padding: '8px 12px', marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '8px', color: 'var(--notion-text)', fontSize: '14px', fontWeight: 500, cursor: 'pointer', borderRadius: '4px' }}
            ...
            >
                ...
                <span style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', maxWidth: '160px' }}>{accountName}</span>
                        ...
                        {isEditingName ? (
                            <div style={{ display: 'flex', gap: '4px' }}>
                                <input
                                    ...
                                    style={{ width: '100%', fontSize: '12px', padding: '4px', border: '1px solid var(--notion-border)', borderRadius: '4px', background: 'var(--notion-bg)' }}
                                    autoFocus
                                />
